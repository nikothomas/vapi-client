...
------------ | ------------- | ------------- | -------------
**fallback_destination** | Option<[**models::ImportTwilioPhoneNumberDtoFallbackDestination**](ImportTwilioPhoneNumberDtoFallbackDestination.md)> |  | [optional]
...
**twilio_auth_token** | **String** | This is the Twilio Auth Token that will be used to handle this phone number. | 
