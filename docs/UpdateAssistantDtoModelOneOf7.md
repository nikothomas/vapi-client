...
**tools** | Option<[**Vec<models::GroqModelToolsItem>**](GroqModelToolsItem.md)> | These are the tools that the assistant can use during the call. To use existing tools, use `toolIds`.  Both `tools` and `toolIds` can be used together. | [optional]
...
**model** | [**models::GroqModelModel**](GroqModelModel.md) |  | 
