...
------------ | ------------- | ------------- | -------------
**fallback_destination** | Option<[**models::VapiPhoneNumberFallbackDestination**](VapiPhoneNumberFallbackDestination.md)> |  | [optional]
...
**status** | Option<[**models::VapiPhoneNumberStatus**](VapiPhoneNumberStatus.md)> |  | [optional]
