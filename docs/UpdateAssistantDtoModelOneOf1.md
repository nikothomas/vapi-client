...
**tools** | Option<[**Vec<models::AnthropicModelToolsItem>**](AnthropicModelToolsItem.md)> | These are the tools that the assistant can use during the call. To use existing tools, use `toolIds`.  Both `tools` and `toolIds` can be used together. | [optional]
...
**model** | [**models::AnthropicModelModel**](AnthropicModelModel.md) |  | 
**thinking** | Option<[**models::AnthropicThinkingConfig**](AnthropicThinkingConfig.md)> |  | [optional]
