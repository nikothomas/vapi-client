...
pub struct ToolsListResponseItemOneOf7 {
    ...
    pub messages: Option<Option<Vec<models::BashToolMessagesItem>>>,
...
impl ToolsListResponseItemOneOf7 {
    pub fn new(sub_type: SubType, id: String, org_id: String, created_at: String, updated_at: String, name: Name, r#type: Type) -> ToolsListResponseItemOneOf7 {
