...
pub struct ToolsListResponseItemOneOf10 {
    ...
    pub messages: Option<Option<Vec<models::QueryToolMessagesItem>>>,
    /// The knowledge bases to query
    #[serde(rename = "knowledgeBases", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub knowledge_bases: Option<Option<Vec<models::KnowledgeBase>>>,
...
impl ToolsListResponseItemOneOf10 {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String, r#type: Type) -> ToolsListResponseItemOneOf10 {
