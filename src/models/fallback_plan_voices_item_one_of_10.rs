...
pub struct FallbackPlanVoicesItemOneOf10 {
    #[serde(rename = "voiceId")]
    pub voice_id: models::FallbackRimeAiVoiceId,
    #[serde(rename = "model", skip_serializing_if = "Option::is_none")]
    pub model: Option<models::FallbackRimeAiVoiceModel>,
...
impl FallbackPlanVoicesItemOneOf10 {
    pub fn new(voice_id: models::FallbackRimeAiVoiceId, provider: Provider) -> FallbackPlanVoicesItemOneOf10 {
