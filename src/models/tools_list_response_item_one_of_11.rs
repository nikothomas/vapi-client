...
pub struct ToolsListResponseItemOneOf11 {
    ...
    pub messages: Option<Option<Vec<models::GoogleCalendarCreateEventToolMessagesItem>>>,
...
impl ToolsListResponseItemOneOf11 {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String, r#type: Type) -> ToolsListResponseItemOneOf11 {
