...
pub struct ToolsUpdateRequestOneOf2 {
    ...
    pub messages: Option<Option<Vec<models::UpdateFunctionToolDtoMessagesItem>>>,
...
impl ToolsUpdateRequestOneOf2 {
    pub fn new(r#type: Type) -> ToolsUpdateRequestOneOf2 {
