...
pub enum ToolControllerUpdateRequest {
    ...
    GohighlevelPeriodCalendarPeriodAvailabilityPeriodCheck(models::UpdateGoHighLevelCalendarAvailabilityToolDto),
    #[serde(rename="gohighlevel.calendar.event.create")]
    GohighlevelPeriodCalendarPeriodEventPeriodCreate(models::UpdateGoHighLevelCalendarEventCreateToolDto),
