...
pub enum CreateDtmfToolDtoMessagesInner {
    ToolMessageStart(Box<models::ToolMessageStart>),
    ToolMessageComplete(Box<models::ToolMessageComplete>),
    ToolMessageFailed(Box<models::ToolMessageFailed>),
    ToolMessageDelayed(Box<models::ToolMessageDelayed>),
}
