...
pub struct ByoSipTrunkCredential {
    ...
    pub outbound_authentication_plan: Option<Box<models::SipTrunkOutboundAuthenticationPlan>>,
    ...
    #[serde(rename = "outboundLeadingPlusEnabled", skip_serializing_if = "Option::is_none")]
