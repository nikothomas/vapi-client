...
pub struct UpdateGoogleCalendarCreateEventToolDto {
    ...
    pub messages: Option<Option<Vec<models::UpdateGoogleCalendarCreateEventToolDtoMessagesItem>>>,
...
impl UpdateGoogleCalendarCreateEventToolDto {
    pub fn new() -> UpdateGoogleCalendarCreateEventToolDto {
