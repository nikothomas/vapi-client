...
pub enum UpdateAzureOpenAiCredentialDtoModelsItem {
...
impl std::fmt::Display for UpdateAzureOpenAiCredentialDtoModelsItem {
...
impl Default for UpdateAzureOpenAiCredentialDtoModelsItem {
    fn default() -> UpdateAzureOpenAiCredentialDtoModelsItem {
        Self::Gpt4o20241120
    }
}
