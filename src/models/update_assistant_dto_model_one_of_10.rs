...
pub struct UpdateAssistantDtoModelOneOf10 {
    ...
    pub tools: Option<Option<Vec<models::OpenRouterModelToolsItem>>>,
...
impl UpdateAssistantDtoModelOneOf10 {
    pub fn new(model: String, provider: Provider) -> UpdateAssistantDtoModelOneOf10 {
