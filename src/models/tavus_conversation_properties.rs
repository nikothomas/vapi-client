...
pub struct TavusConversationProperties {
    ...
    #[serde(rename = "maxCallDuration", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub max_call_duration: Option<Option<f64>>,
    /// The duration in seconds after which the call will be automatically shut down once the last participant leaves.
    #[serde(rename = "participantLeftTimeout", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub participant_left_timeout: Option<Option<f64>>,
    ...
    #[serde(rename = "participantAbsentTimeout", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub participant_absent_timeout: Option<Option<f64>>,
    /// If true, the user will be able to record the conversation.
    #[serde(rename = "enableRecording", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub enable_recording: Option<Option<bool>>,
    ...
    #[serde(rename = "enableTranscription", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub enable_transcription: Option<Option<bool>>,
    ...
    #[serde(rename = "applyGreenscreen", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub apply_greenscreen: Option<Option<bool>>,
    ...
    #[serde(rename = "recordingS3BucketName", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub recording_s3_bucket_name: Option<Option<String>>,
    /// The region of the S3 bucket where the recording will be stored.
    #[serde(rename = "recordingS3BucketRegion", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub recording_s3_bucket_region: Option<Option<String>>,
    /// The ARN of the role that will be assumed to access the S3 bucket.
    #[serde(rename = "awsAssumeRoleArn", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub aws_assume_role_arn: Option<Option<String>>,
}
