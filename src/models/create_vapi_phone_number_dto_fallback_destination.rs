...
#[serde(untagged)]
pub enum CreateVapiPhoneNumberDtoFallbackDestination {
...
impl Default for CreateVapiPhoneNumberDtoFallbackDestination {
    fn default() -> Self {
