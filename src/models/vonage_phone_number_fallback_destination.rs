...
#[serde(untagged)]
pub enum VonagePhoneNumberFallbackDestination {
...
impl Default for VonagePhoneNumberFallbackDestination {
    fn default() -> Self {
