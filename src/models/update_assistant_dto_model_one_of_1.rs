...
pub struct UpdateAssistantDtoModelOneOf1 {
    ...
    pub tools: Option<Option<Vec<models::AnthropicModelToolsItem>>>,
    ...
    #[serde(rename = "model")]
    pub model: models::AnthropicModelModel,
...
impl UpdateAssistantDtoModelOneOf1 {
    pub fn new(model: models::AnthropicModelModel, provider: Provider) -> UpdateAssistantDtoModelOneOf1 {
