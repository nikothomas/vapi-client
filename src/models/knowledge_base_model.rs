...
/// KnowledgeBaseModel : The model to use for the knowledge base
/// The model to use for the knowledge base
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum KnowledgeBaseModel {
...
impl std::fmt::Display for KnowledgeBaseModel {
...
impl Default for KnowledgeBaseModel {
    fn default() -> KnowledgeBaseModel {
