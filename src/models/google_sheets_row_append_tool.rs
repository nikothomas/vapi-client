...
pub struct GoogleSheetsRowAppendTool {
...
impl GoogleSheetsRowAppendTool {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String) -> GoogleSheetsRowAppendTool {
