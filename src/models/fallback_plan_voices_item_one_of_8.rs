...
pub struct FallbackPlanVoicesItemOneOf8 {
...
impl FallbackPlanVoicesItemOneOf8 {
    pub fn new(voice_id: models::FallbackOpenAiVoiceId, provider: Provider) -> FallbackPlanVoicesItemOneOf8 {
