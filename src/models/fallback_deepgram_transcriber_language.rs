...
pub enum FallbackDeepgramTranscriberLanguage {
    #[serde(rename = "bg")]
    Bg,
    #[serde(rename = "ca")]
    Ca,
...
impl std::fmt::Display for FallbackDeepgramTranscriberLanguage {
...
impl Default for FallbackDeepgramTranscriberLanguage {
    fn default() -> FallbackDeepgramTranscriberLanguage {
        Self::Bg
    }
}
