...
pub struct ToolsListResponseItemOneOf5 {
    ...
    pub messages: Option<Option<Vec<models::TransferCallToolMessagesItem>>>,
    ...
    #[serde(rename = "destinations", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub destinations: Option<Option<Vec<models::TransferCallToolDestinationsItem>>>,
...
impl ToolsListResponseItemOneOf5 {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String, r#type: Type) -> ToolsListResponseItemOneOf5 {
