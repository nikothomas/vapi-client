...
pub struct AnyscaleModelToolsItemOneOf {
    ...
    pub messages: Option<Option<Vec<models::CreateVoicemailToolDtoMessagesItem>>>,
...
impl AnyscaleModelToolsItemOneOf {
    pub fn new(r#type: Type) -> AnyscaleModelToolsItemOneOf {
