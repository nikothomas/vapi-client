...
pub struct ClientMessageToolCallsResult {
    ...
    pub tool_call_result: std::collections::HashMap<String, serde_json::Value>,
}

impl ClientMessageToolCallsResult {
    pub fn new(r#type: Type, tool_call_result: std::collections::HashMap<String, serde_json::Value>) -> ClientMessageToolCallsResult {
