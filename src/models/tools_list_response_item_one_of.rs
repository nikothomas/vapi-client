...
pub struct ToolsListResponseItemOneOf {
    ...
    pub messages: Option<Option<Vec<models::DtmfToolMessagesItem>>>,
...
impl ToolsListResponseItemOneOf {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String, r#type: Type) -> ToolsListResponseItemOneOf {
