...
pub enum CreateAssistantDtoServerMessagesItem {
...
impl std::fmt::Display for CreateAssistantDtoServerMessagesItem {
...
impl Default for CreateAssistantDtoServerMessagesItem {
    fn default() -> CreateAssistantDtoServerMessagesItem {
