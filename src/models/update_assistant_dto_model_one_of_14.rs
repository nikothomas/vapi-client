...
pub struct UpdateAssistantDtoModelOneOf14 {
    ...
    pub tools: Option<Option<Vec<models::XaiModelToolsItem>>>,
    ...
    #[serde(rename = "model")]
    pub model: models::XaiModelModel,
...
impl UpdateAssistantDtoModelOneOf14 {
    pub fn new(model: models::XaiModelModel, provider: Provider) -> UpdateAssistantDtoModelOneOf14 {
