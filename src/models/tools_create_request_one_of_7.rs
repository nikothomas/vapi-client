...
pub struct ToolsCreateRequestOneOf7 {
    ...
    pub messages: Option<Option<Vec<models::CreateBashToolDtoMessagesItem>>>,
...
impl ToolsCreateRequestOneOf7 {
    pub fn new(sub_type: SubType, name: Name, r#type: Type) -> ToolsCreateRequestOneOf7 {
