...
pub struct UpdateAssistantDtoVoicemailDetectionOneOf2 {
    ...
    #[serde(rename = "voicemailDetectionTypes", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub voicemail_detection_types: Option<Option<Vec<models::TwilioVoicemailDetectionPlanVoicemailDetectionTypesItem>>>,
    ...
    #[serde(rename = "machineDetectionTimeout", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub machine_detection_timeout: Option<Option<f64>>,
    ...
    #[serde(rename = "machineDetectionSpeechThreshold", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub machine_detection_speech_threshold: Option<Option<f64>>,
    ...
    #[serde(rename = "machineDetectionSpeechEndThreshold", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub machine_detection_speech_end_threshold: Option<Option<f64>>,
    ...
    #[serde(rename = "machineDetectionSilenceTimeout", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub machine_detection_silence_timeout: Option<Option<f64>>,
    #[serde(rename = "provider")]
    pub provider: Provider,
}

impl UpdateAssistantDtoVoicemailDetectionOneOf2 {
    pub fn new(provider: Provider) -> UpdateAssistantDtoVoicemailDetectionOneOf2 {
