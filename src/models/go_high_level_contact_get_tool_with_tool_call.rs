...
pub struct GoHighLevelContactGetToolWithToolCall {
...
impl GoHighLevelContactGetToolWithToolCall {
    pub fn new(r#type: TypeTrue, tool_call: models::ToolCall) -> GoHighLevelContactGetToolWithToolCall {
...
impl Default for TypeTrue {
    fn default() -> TypeTrue {
        Self::GohighlevelPeriodContactPeriodGet
    }
}
