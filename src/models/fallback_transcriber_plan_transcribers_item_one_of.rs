...
pub struct FallbackTranscriberPlanTranscribersItemOneOf {
...
impl FallbackTranscriberPlanTranscribersItemOneOf {
    pub fn new(provider: Provider) -> FallbackTranscriberPlanTranscribersItemOneOf {
