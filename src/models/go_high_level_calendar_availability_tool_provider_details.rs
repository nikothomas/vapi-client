...
pub struct GoHighLevelCalendarAvailabilityToolProviderDetails {
...
impl GoHighLevelCalendarAvailabilityToolProviderDetails {
    pub fn new(r#type: TypeTrue) -> GoHighLevelCalendarAvailabilityToolProviderDetails {
