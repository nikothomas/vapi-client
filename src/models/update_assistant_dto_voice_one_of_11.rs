...
pub struct UpdateAssistantDtoVoiceOneOf11 {
...
impl UpdateAssistantDtoVoiceOneOf11 {
    pub fn new(voice_id: models::SmallestAiVoiceId, provider: Provider) -> UpdateAssistantDtoVoiceOneOf11 {
