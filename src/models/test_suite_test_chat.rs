...
impl TestSuiteTestChat {
    pub fn new(scorers: Vec<models::TestSuiteTestVoiceScorersInner>, r#type: TypeTrue, id: String, test_suite_id: String, org_id: String, created_at: String, updated_at: String, script: String) -> TestSuiteTestChat {
        TestSuiteTestChat {
            scorers,
            r#type,
            id,
