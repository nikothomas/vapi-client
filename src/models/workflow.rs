...
impl Workflow {
    pub fn new(nodes: Vec<models::WorkflowUserEditableNodesInner>, id: String, org_id: String, created_at: String, updated_at: String, name: String, edges: Vec<models::Edge>) -> Workflow {
        Workflow {
            nodes,
            transcriber: None,
            voice: None,
