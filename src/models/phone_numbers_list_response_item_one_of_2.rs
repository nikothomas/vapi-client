...
pub struct PhoneNumbersListResponseItemOneOf2 {
...
impl PhoneNumbersListResponseItemOneOf2 {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String, number: String, credential_id: String, provider: Provider) -> PhoneNumbersListResponseItemOneOf2 {
