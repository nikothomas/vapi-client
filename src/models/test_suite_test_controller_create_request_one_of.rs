...
pub struct TestSuiteTestControllerCreateRequestOneOf {
...
impl TestSuiteTestControllerCreateRequestOneOf {
    pub fn new(scorers: Vec<models::TestSuiteTestScorerAi>, script: String, r#type: Type) -> TestSuiteTestControllerCreateRequestOneOf {
