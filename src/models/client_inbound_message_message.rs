...
pub enum ClientInboundMessageMessage {
    ClientInboundMessageAddMessage(Box<models::ClientInboundMessageAddMessage>),
    ClientInboundMessageControl(Box<models::ClientInboundMessageControl>),
    ClientInboundMessageSay(Box<models::ClientInboundMessageSay>),
    ClientInboundMessageEndCall(Box<models::ClientInboundMessageEndCall>),
    ClientInboundMessageTransfer(Box<models::ClientInboundMessageTransfer>),
}
