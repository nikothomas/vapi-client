...
pub struct ToolsUpdateRequestOneOf3 {
    ...
    pub messages: Option<Option<Vec<models::UpdateGhlToolDtoMessagesItem>>>,
    #[serde(rename = "function", skip_serializing_if = "Option::is_none")]
    pub function: Option<models::OpenAiFunction>,
    #[serde(rename = "server", skip_serializing_if = "Option::is_none")]
    pub server: Option<models::Server>,
    #[serde(rename = "metadata", skip_serializing_if = "Option::is_none")]
    pub metadata: Option<models::GhlToolMetadata>,
    #[serde(rename = "type")]
    pub r#type: Type,
}

impl ToolsUpdateRequestOneOf3 {
    pub fn new(r#type: Type) -> ToolsUpdateRequestOneOf3 {
