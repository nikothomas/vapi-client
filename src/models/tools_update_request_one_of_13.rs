...
pub struct ToolsUpdateRequestOneOf13 {
    ...
    pub messages: Option<Option<Vec<models::UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem>>>,
...
impl ToolsUpdateRequestOneOf13 {
    pub fn new(r#type: Type) -> ToolsUpdateRequestOneOf13 {
