...
pub enum CreateAssistantDtoFirstMessageMode {
...
impl std::fmt::Display for CreateAssistantDtoFirstMessageMode {
...
impl Default for CreateAssistantDtoFirstMessageMode {
    fn default() -> CreateAssistantDtoFirstMessageMode {
