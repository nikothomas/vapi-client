...
pub enum CreateAssistantDtoVoicemailDetection {
    GoogleVoicemailDetectionPlan(Box<models::GoogleVoicemailDetectionPlan>),
    OpenAiVoicemailDetectionPlan(Box<models::OpenAiVoicemailDetectionPlan>),
    TwilioVoicemailDetectionPlan(Box<models::TwilioVoicemailDetectionPlan>),
}
