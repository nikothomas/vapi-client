...
pub struct GoogleSheetsRowAppendToolWithToolCall {
    ...
    pub messages: Option<Option<Vec<models::GoogleSheetsRowAppendToolWithToolCallMessagesItem>>>,
...
impl GoogleSheetsRowAppendToolWithToolCall {
    pub fn new(r#type: Type, tool_call: models::ToolCall) -> GoogleSheetsRowAppendToolWithToolCall {
