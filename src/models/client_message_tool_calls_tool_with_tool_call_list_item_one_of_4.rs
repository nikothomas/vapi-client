...
pub struct ClientMessageToolCallsToolWithToolCallListItemOneOf4 {
...
impl ClientMessageToolCallsToolWithToolCallListItemOneOf4 {
    pub fn new(sub_type: SubType, tool_call: models::ToolCall, name: Name, display_width_px: f64, display_height_px: f64, r#type: Type) -> ClientMessageToolCallsToolWithToolCallListItemOneOf4 {
