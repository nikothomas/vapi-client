...
pub struct GoogleCalendarCheckAvailabilityTool {
...
impl GoogleCalendarCheckAvailabilityTool {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String) -> GoogleCalendarCheckAvailabilityTool {
