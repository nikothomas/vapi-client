...
pub struct PhoneNumbersListResponseItemOneOf3 {
...
impl PhoneNumbersListResponseItemOneOf3 {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String, provider: Provider) -> PhoneNumbersListResponseItemOneOf3 {
