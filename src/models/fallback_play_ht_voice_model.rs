...
/// FallbackPlayHtVoiceModel : Playht voice model/engine to use.
/// Playht voice model/engine to use.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum FallbackPlayHtVoiceModel {
...
impl std::fmt::Display for FallbackPlayHtVoiceModel {
...
impl Default for FallbackPlayHtVoiceModel {
    fn default() -> FallbackPlayHtVoiceModel {
        Self::PlayHt2Period0
    }
}
