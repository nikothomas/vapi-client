...
/// GoogleModelModel : This is the Google model that will be used.
/// This is the Google model that will be used.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum GoogleModelModel {
...
impl std::fmt::Display for GoogleModelModel {
...
impl Default for GoogleModelModel {
    fn default() -> GoogleModelModel {
