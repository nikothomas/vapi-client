...
/// GoogleTranscriberModel : This is the model that will be used for the transcription.
/// This is the model that will be used for the transcription.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum GoogleTranscriberModel {
...
impl std::fmt::Display for GoogleTranscriberModel {
...
impl Default for GoogleTranscriberModel {
    fn default() -> GoogleTranscriberModel {
