...
pub struct ToolsCreateRequestOneOf13 {
    ...
    pub messages: Option<Option<Vec<models::CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem>>>,
...
impl ToolsCreateRequestOneOf13 {
    pub fn new(r#type: Type) -> ToolsCreateRequestOneOf13 {
