...
pub struct GoHighLevelCalendarAvailabilityToolWithToolCall {
...
impl GoHighLevelCalendarAvailabilityToolWithToolCall {
    pub fn new(r#type: TypeTrue, tool_call: models::ToolCall) -> GoHighLevelCalendarAvailabilityToolWithToolCall {
