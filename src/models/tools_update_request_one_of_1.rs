...
pub struct ToolsUpdateRequestOneOf1 {
    ...
    pub messages: Option<Option<Vec<models::UpdateEndCallToolDtoMessagesItem>>>,
...
impl ToolsUpdateRequestOneOf1 {
    pub fn new(r#type: Type) -> ToolsUpdateRequestOneOf1 {
