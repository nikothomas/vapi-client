...
pub struct UpdateGoHighLevelCalendarEventCreateToolDto {
...
impl UpdateGoHighLevelCalendarEventCreateToolDto {
    pub fn new() -> UpdateGoHighLevelCalendarEventCreateToolDto {
