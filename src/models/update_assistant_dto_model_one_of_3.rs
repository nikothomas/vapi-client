...
pub struct UpdateAssistantDtoModelOneOf3 {
    ...
    pub tools: Option<Option<Vec<models::CustomLlmModelToolsItem>>>,
    ...
    pub metadata_send_mode: Option<models::CustomLlmModelMetadataSendMode>,
...
impl UpdateAssistantDtoModelOneOf3 {
    pub fn new(url: String, model: String, provider: Provider) -> UpdateAssistantDtoModelOneOf3 {
