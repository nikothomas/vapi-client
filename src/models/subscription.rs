...
pub struct Subscription {
    ...
    #[serde(rename = "phoneNumbersCounter", skip_serializing_if = "Option::is_none")]
    pub phone_numbers_counter: Option<f64>,
    /// This is the maximum number of free phone numbers the subscription can have
    #[serde(rename = "phoneNumbersIncluded", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "monthlyChargeScheduleId", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "monthlyCreditCheckScheduleId", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "stripePaymentMethodId", skip_serializing_if = "Option::is_none")]
    pub stripe_payment_method_id: Option<String>,
    /// If this flag is true, then the user has purchased slack support.
    #[serde(rename = "slackSupportEnabled", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "hipaaCommonPaperAgreementId", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "stripePaymentMethodFingerprint", skip_serializing_if = "Option::is_none")]
    pub stripe_payment_method_fingerprint: Option<String>,
    /// This is the customer's email on Stripe.
    #[serde(rename = "stripeCustomerEmail", skip_serializing_if = "Option::is_none")]
    ...
    pub auto_reload_plan: Option<Box<models::AutoReloadPlan>>,
    ...
    #[serde(rename = "minutesUsedNextResetAt", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "outboundCallsDailyLimit", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "outboundCallsCounter", skip_serializing_if = "Option::is_none")]
    pub outbound_calls_counter: Option<f64>,
    /// This is the timestamp at which the outbound calls counter is scheduled to reset at.
    #[serde(rename = "outboundCallsCounterNextResetAt", skip_serializing_if = "Option::is_none")]
    ...
    pub invoice_plan: Option<Box<models::InvoicePlan>>,
}
