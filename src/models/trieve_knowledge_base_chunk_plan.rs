...
pub struct TrieveKnowledgeBaseChunkPlan {
    ...
    #[serde(rename = "fileIds", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub file_ids: Option<Option<Vec<String>>>,
    /// These are the websites that will be used to create the vector store.
    #[serde(rename = "websites", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub websites: Option<Option<Vec<String>>>,
    ...
    #[serde(rename = "targetSplitsPerChunk", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub target_splits_per_chunk: Option<Option<f64>>,
    ...
    #[serde(rename = "splitDelimiters", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "rebalanceChunks", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
