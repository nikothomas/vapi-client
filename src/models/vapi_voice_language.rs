...
/// VapiVoiceLanguage : This is the language code (ISO 639-1) that will be used.  @default 'en-US'
/// This is the language code (ISO 639-1) that will be used.  @default 'en-US'
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum VapiVoiceLanguage {
    #[serde(rename = "en-US")]
    EnUs,
    #[serde(rename = "en-GB")]
    EnGb,
...
impl std::fmt::Display for VapiVoiceLanguage {
...
impl Default for VapiVoiceLanguage {
    fn default() -> VapiVoiceLanguage {
        Self::EnUs
    }
}
