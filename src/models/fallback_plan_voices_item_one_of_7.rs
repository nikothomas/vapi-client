...
pub struct FallbackPlanVoicesItemOneOf7 {
...
impl FallbackPlanVoicesItemOneOf7 {
    pub fn new(voice_id: models::FallbackLmntVoiceId, provider: Provider) -> FallbackPlanVoicesItemOneOf7 {
