...
pub struct UpdateWorkflowDtoNodesItemOneOf1 {
    #[serde(rename = "output")]
...
impl UpdateWorkflowDtoNodesItemOneOf1 {
    pub fn new(output: models::JsonSchema, name: String, r#type: Type) -> UpdateWorkflowDtoNodesItemOneOf1 {
