...
pub struct ClientMessageToolCallsToolWithToolCallListItemOneOf {
    ...
    pub messages: Option<Option<Vec<models::FunctionToolWithToolCallMessagesItem>>>,
...
impl ClientMessageToolCallsToolWithToolCallListItemOneOf {
    pub fn new(tool_call: models::ToolCall, r#type: Type) -> ClientMessageToolCallsToolWithToolCallListItemOneOf {
