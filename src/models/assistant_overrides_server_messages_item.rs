...
pub enum AssistantOverridesServerMessagesItem {
...
impl std::fmt::Display for AssistantOverridesServerMessagesItem {
...
impl Default for AssistantOverridesServerMessagesItem {
    fn default() -> AssistantOverridesServerMessagesItem {
