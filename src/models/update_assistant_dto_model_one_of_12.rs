...
pub struct UpdateAssistantDtoModelOneOf12 {
    ...
    pub tools: Option<Option<Vec<models::TogetherAiModelToolsItem>>>,
...
impl UpdateAssistantDtoModelOneOf12 {
    pub fn new(model: String, provider: Provider) -> UpdateAssistantDtoModelOneOf12 {
