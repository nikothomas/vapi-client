...
pub struct UpdateAssistantDtoModelOneOf {
    ...
    pub tools: Option<Option<Vec<models::AnyscaleModelToolsItem>>>,
...
impl UpdateAssistantDtoModelOneOf {
    pub fn new(model: String, provider: Provider) -> UpdateAssistantDtoModelOneOf {
