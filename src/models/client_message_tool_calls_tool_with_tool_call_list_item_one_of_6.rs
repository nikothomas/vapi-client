...
pub struct ClientMessageToolCallsToolWithToolCallListItemOneOf6 {
    ...
    pub messages: Option<Option<Vec<models::GoogleCalendarCreateEventToolWithToolCallMessagesItem>>>,
...
impl ClientMessageToolCallsToolWithToolCallListItemOneOf6 {
    pub fn new(tool_call: models::ToolCall, r#type: Type) -> ClientMessageToolCallsToolWithToolCallListItemOneOf6 {
