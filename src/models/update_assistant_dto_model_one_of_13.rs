...
pub struct UpdateAssistantDtoModelOneOf13 {
    ...
    pub tools: Option<Option<Vec<models::VapiModelToolsItem>>>,
...
impl UpdateAssistantDtoModelOneOf13 {
    pub fn new(model: String, provider: Provider) -> UpdateAssistantDtoModelOneOf13 {
