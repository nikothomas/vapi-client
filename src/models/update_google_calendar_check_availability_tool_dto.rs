...
pub struct UpdateGoogleCalendarCheckAvailabilityToolDto {
...
impl UpdateGoogleCalendarCheckAvailabilityToolDto {
    pub fn new() -> UpdateGoogleCalendarCheckAvailabilityToolDto {
