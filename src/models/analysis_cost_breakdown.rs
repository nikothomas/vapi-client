...
pub struct AnalysisCostBreakdown {
    ...
    #[serde(rename = "summaryPromptTokens", skip_serializing_if = "Option::is_none")]
    pub summary_prompt_tokens: Option<f64>,
    /// This is the number of completion tokens used to summarize the call.
    #[serde(rename = "summaryCompletionTokens", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "structuredDataPromptTokens", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "structuredDataCompletionTokens", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "successEvaluationPromptTokens", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "successEvaluationCompletionTokens", skip_serializing_if = "Option::is_none")]
