...
pub struct UpdateAssistantDtoModelOneOf8 {
    ...
    pub tools: Option<Option<Vec<models::InflectionAiModelToolsItem>>>,
...
impl UpdateAssistantDtoModelOneOf8 {
    pub fn new(model: Model, provider: Provider) -> UpdateAssistantDtoModelOneOf8 {
