...
pub struct UpdateAssistantDtoModelOneOf2 {
...
impl UpdateAssistantDtoModelOneOf2 {
    pub fn new(model: models::CerebrasModelModel, provider: Provider) -> UpdateAssistantDtoModelOneOf2 {
