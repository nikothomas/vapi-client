...
pub struct ToolsCreateRequestOneOf4 {
    ...
    pub messages: Option<Option<Vec<models::CreateMakeToolDtoMessagesItem>>>,
...
impl ToolsCreateRequestOneOf4 {
    pub fn new(metadata: models::MakeToolMetadata, r#type: Type) -> ToolsCreateRequestOneOf4 {
