...
pub struct MakeToolWithToolCall {
    ...
    pub tool_call: Box<models::ToolCall>,
    #[serde(rename = "metadata")]
    pub metadata: Box<models::MakeToolMetadata>,
...
impl MakeToolWithToolCall {
    pub fn new(r#type: Type, tool_call: models::ToolCall, metadata: models::MakeToolMetadata) -> MakeToolWithToolCall {
