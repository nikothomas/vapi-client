...
pub struct ToolsUpdateRequestOneOf6 {
    ...
    pub messages: Option<Option<Vec<models::UpdateOutputToolDtoMessagesItem>>>,
...
impl ToolsUpdateRequestOneOf6 {
    pub fn new(r#type: Type) -> ToolsUpdateRequestOneOf6 {
