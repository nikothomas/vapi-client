...
pub struct ToolsCreateRequestOneOf6 {
    ...
    pub messages: Option<Option<Vec<models::CreateOutputToolDtoMessagesItem>>>,
...
impl ToolsCreateRequestOneOf6 {
    pub fn new(r#type: Type) -> ToolsCreateRequestOneOf6 {
