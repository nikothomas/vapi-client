...
pub struct ClientInboundMessageMessageOneOf {
...
impl ClientInboundMessageMessageOneOf {
    pub fn new(message: models::OpenAiMessage, r#type: Type) -> ClientInboundMessageMessageOneOf {
