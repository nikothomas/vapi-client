...
pub struct GoHighLevelCalendarEventCreateTool {
...
impl GoHighLevelCalendarEventCreateTool {
    pub fn new(r#type: TypeTrue, id: String, org_id: String, created_at: String, updated_at: String) -> GoHighLevelCalendarEventCreateTool {
