...
pub struct PhoneNumbersCreateRequestOneOf {
    #[serde(rename = "fallbackDestination", skip_serializing_if = "Option::is_none")]
    pub fallback_destination: Option<models::CreateByoPhoneNumberDtoFallbackDestination>,
...
impl PhoneNumbersCreateRequestOneOf {
    pub fn new(credential_id: String, provider: Provider) -> PhoneNumbersCreateRequestOneOf {
