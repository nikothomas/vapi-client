...
impl VoicemailDetectionCost {
    pub fn new(r#type: Type, model: serde_json::Value, provider: Provider, prompt_text_tokens: f64, prompt_audio_tokens: f64, completion_text_tokens: f64, completion_audio_tokens: f64, cost: f64) -> VoicemailDetectionCost {
