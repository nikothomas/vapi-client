...
impl TelnyxPhoneNumber {
    pub fn new(provider: ProviderTrue, id: String, org_id: String, created_at: String, updated_at: String, number: String, credential_id: String) -> TelnyxPhoneNumber {
        TelnyxPhoneNumber {
