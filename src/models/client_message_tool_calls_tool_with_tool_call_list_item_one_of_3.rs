...
pub struct ClientMessageToolCallsToolWithToolCallListItemOneOf3 {
...
impl ClientMessageToolCallsToolWithToolCallListItemOneOf3 {
    pub fn new(sub_type: SubType, tool_call: models::ToolCall, name: Name, r#type: Type) -> ClientMessageToolCallsToolWithToolCallListItemOneOf3 {
