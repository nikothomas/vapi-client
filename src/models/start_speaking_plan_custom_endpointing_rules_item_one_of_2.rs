...
pub struct StartSpeakingPlanCustomEndpointingRulesItemOneOf2 {
...
impl StartSpeakingPlanCustomEndpointingRulesItemOneOf2 {
    pub fn new(assistant_regex: String, customer_regex: String, timeout_seconds: f64, r#type: Type) -> StartSpeakingPlanCustomEndpointingRulesItemOneOf2 {
