...
pub enum WorkflowUserEditableCredentialsInner {
    ...
    GooglePeriodCalendarPeriodOauth2Authorization(models::CreateGoogleCalendarOAuth2AuthorizationCredentialDto),
    #[serde(rename="google.sheets.oauth2-authorization")]
    GooglePeriodSheetsPeriodOauth2Authorization(models::CreateGoogleSheetsOAuth2AuthorizationCredentialDto),
