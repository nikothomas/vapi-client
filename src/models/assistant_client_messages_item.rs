...
pub enum AssistantClientMessagesItem {
...
impl std::fmt::Display for AssistantClientMessagesItem {
...
impl Default for AssistantClientMessagesItem {
    fn default() -> AssistantClientMessagesItem {
