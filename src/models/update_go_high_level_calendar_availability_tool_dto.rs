...
pub struct UpdateGoHighLevelCalendarAvailabilityToolDto {
...
impl UpdateGoHighLevelCalendarAvailabilityToolDto {
    pub fn new() -> UpdateGoHighLevelCalendarAvailabilityToolDto {
