...
pub struct UpdateAssistantDtoModelOneOf6 {
    ...
    pub tools: Option<Option<Vec<models::GoogleModelToolsItem>>>,
    ...
    #[serde(rename = "model")]
    pub model: models::GoogleModelModel,
...
impl UpdateAssistantDtoModelOneOf6 {
    pub fn new(model: models::GoogleModelModel, provider: Provider) -> UpdateAssistantDtoModelOneOf6 {
