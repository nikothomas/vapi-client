...
pub struct TranscriptionEndpointingPlan {
    ...
    #[serde(rename = "onPunctuationSeconds", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub on_punctuation_seconds: Option<Option<f64>>,
    ...
    #[serde(rename = "onNoPunctuationSeconds", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub on_no_punctuation_seconds: Option<Option<f64>>,
    ...
    #[serde(rename = "onNumberSeconds", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub on_number_seconds: Option<Option<f64>>,
}
