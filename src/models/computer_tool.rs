...
impl ComputerTool {
    pub fn new(sub_type: SubType, id: String, org_id: String, created_at: String, updated_at: String, name: Name, display_width_px: f64, display_height_px: f64) -> ComputerTool {
        ComputerTool {
            r#async: None,
            messages: None,
            sub_type,
