...
pub struct WorkflowUserEditable {
    #[serde(rename = "nodes")]
    pub nodes: Vec<models::WorkflowUserEditableNodesInner>,
...
impl WorkflowUserEditable {
    pub fn new(nodes: Vec<models::WorkflowUserEditableNodesInner>, name: String, edges: Vec<models::Edge>) -> WorkflowUserEditable {
