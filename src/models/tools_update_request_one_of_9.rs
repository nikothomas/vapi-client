...
pub struct ToolsUpdateRequestOneOf9 {
    ...
    pub messages: Option<Option<Vec<models::UpdateTextEditorToolDtoMessagesItem>>>,
...
impl ToolsUpdateRequestOneOf9 {
    pub fn new(r#type: Type) -> ToolsUpdateRequestOneOf9 {
