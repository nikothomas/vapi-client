...
/// ServerMessageSpeechUpdatePhoneNumber : This is the phone number associated with the call.  This matches one of the following: - `call.phoneNumber`, - `call.phoneNumberId`.
...
#[serde(untagged)]
pub enum ServerMessageSpeechUpdatePhoneNumber {
...
impl Default for ServerMessageSpeechUpdatePhoneNumber {
    fn default() -> Self {
