...
/// OpenAiModelModel : This is the OpenAI model that will be used.
/// This is the OpenAI model that will be used.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum OpenAiModelModel {
...
impl std::fmt::Display for OpenAiModelModel {
...
impl Default for OpenAiModelModel {
    fn default() -> OpenAiModelModel {
