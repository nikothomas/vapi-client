...
#[serde(untagged)]
pub enum CreateTwilioPhoneNumberDtoFallbackDestination {
...
impl Default for CreateTwilioPhoneNumberDtoFallbackDestination {
    fn default() -> Self {
