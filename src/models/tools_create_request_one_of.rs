...
pub struct ToolsCreateRequestOneOf {
    ...
    pub messages: Option<Option<Vec<models::CreateDtmfToolDtoMessagesItem>>>,
...
impl ToolsCreateRequestOneOf {
    pub fn new(r#type: Type) -> ToolsCreateRequestOneOf {
