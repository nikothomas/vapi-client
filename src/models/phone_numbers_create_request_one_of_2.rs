...
pub struct PhoneNumbersCreateRequestOneOf2 {
    #[serde(rename = "fallbackDestination", skip_serializing_if = "Option::is_none")]
    pub fallback_destination: Option<models::CreateVonagePhoneNumberDtoFallbackDestination>,
...
impl PhoneNumbersCreateRequestOneOf2 {
    pub fn new(number: String, credential_id: String, provider: Provider) -> PhoneNumbersCreateRequestOneOf2 {
