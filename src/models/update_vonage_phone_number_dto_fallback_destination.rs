...
#[serde(untagged)]
pub enum UpdateVonagePhoneNumberDtoFallbackDestination {
...
impl Default for UpdateVonagePhoneNumberDtoFallbackDestination {
    fn default() -> Self {
