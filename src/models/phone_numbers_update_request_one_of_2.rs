...
pub struct PhoneNumbersUpdateRequestOneOf2 {
    #[serde(rename = "fallbackDestination", skip_serializing_if = "Option::is_none")]
    pub fallback_destination: Option<models::UpdateVonagePhoneNumberDtoFallbackDestination>,
...
impl PhoneNumbersUpdateRequestOneOf2 {
    pub fn new(provider: Provider) -> PhoneNumbersUpdateRequestOneOf2 {
