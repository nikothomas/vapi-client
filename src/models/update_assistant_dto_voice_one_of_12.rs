...
pub struct UpdateAssistantDtoVoiceOneOf12 {
...
impl UpdateAssistantDtoVoiceOneOf12 {
    pub fn new(voice_id: models::TavusVoiceVoiceId, provider: Provider) -> UpdateAssistantDtoVoiceOneOf12 {
