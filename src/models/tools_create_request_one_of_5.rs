...
pub struct ToolsCreateRequestOneOf5 {
    ...
    pub messages: Option<Option<Vec<models::CreateTransferCallToolDtoMessagesItem>>>,
    ...
    pub destinations: Option<Option<Vec<models::CreateTransferCallToolDtoDestinationsItem>>>,
...
impl ToolsCreateRequestOneOf5 {
    pub fn new(r#type: Type) -> ToolsCreateRequestOneOf5 {
