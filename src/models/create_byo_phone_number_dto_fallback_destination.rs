...
#[serde(untagged)]
pub enum CreateByoPhoneNumberDtoFallbackDestination {
...
impl Default for CreateByoPhoneNumberDtoFallbackDestination {
    fn default() -> Self {
