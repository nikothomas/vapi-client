...
pub struct ToolsUpdateRequestOneOf4 {
    ...
    pub messages: Option<Option<Vec<models::UpdateMakeToolDtoMessagesItem>>>,
    #[serde(rename = "function", skip_serializing_if = "Option::is_none")]
    pub function: Option<models::OpenAiFunction>,
    #[serde(rename = "server", skip_serializing_if = "Option::is_none")]
    pub server: Option<models::Server>,
    #[serde(rename = "metadata", skip_serializing_if = "Option::is_none")]
    pub metadata: Option<models::MakeToolMetadata>,
    #[serde(rename = "type")]
    pub r#type: Type,
}

impl ToolsUpdateRequestOneOf4 {
    pub fn new(r#type: Type) -> ToolsUpdateRequestOneOf4 {
