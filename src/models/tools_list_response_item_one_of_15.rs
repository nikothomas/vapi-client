...
pub struct ToolsListResponseItemOneOf15 {
    ...
    pub messages: Option<Option<Vec<models::McpToolMessagesItem>>>,
...
impl ToolsListResponseItemOneOf15 {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String, r#type: Type) -> ToolsListResponseItemOneOf15 {
