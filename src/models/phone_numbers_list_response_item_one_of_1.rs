...
pub struct PhoneNumbersListResponseItemOneOf1 {
...
impl PhoneNumbersListResponseItemOneOf1 {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String, number: String, twilio_account_sid: String, twilio_auth_token: String, provider: Provider) -> PhoneNumbersListResponseItemOneOf1 {
