...
pub struct CreateGoHighLevelCalendarEventCreateToolDto {
...
impl CreateGoHighLevelCalendarEventCreateToolDto {
    pub fn new(r#type: TypeTrue) -> CreateGoHighLevelCalendarEventCreateToolDto {
