...
pub struct UpdateAssistantDtoVoiceOneOf8 {
...
impl UpdateAssistantDtoVoiceOneOf8 {
    pub fn new(voice_id: models::OpenAiVoiceId, provider: Provider) -> UpdateAssistantDtoVoiceOneOf8 {
