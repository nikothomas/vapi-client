...
pub struct ToolsListResponseItemOneOf1 {
...
impl ToolsListResponseItemOneOf1 {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String, r#type: Type) -> ToolsListResponseItemOneOf1 {
