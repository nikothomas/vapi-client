...
pub struct ToolsListResponseItemOneOf8 {
    ...
    pub messages: Option<Option<Vec<models::ComputerToolMessagesItem>>>,
...
impl ToolsListResponseItemOneOf8 {
    pub fn new(sub_type: SubType, id: String, org_id: String, created_at: String, updated_at: String, name: Name, display_width_px: f64, display_height_px: f64, r#type: Type) -> ToolsListResponseItemOneOf8 {
