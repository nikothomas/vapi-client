...
pub struct ToolsListResponseItemOneOf12 {
    ...
    pub messages: Option<Option<Vec<models::GoogleSheetsRowAppendToolMessagesItem>>>,
...
impl ToolsListResponseItemOneOf12 {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String, r#type: Type) -> ToolsListResponseItemOneOf12 {
