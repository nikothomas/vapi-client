...
pub struct MessagePlan {
    ...
    #[serde(rename = "idleMessages", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub idle_messages: Option<Option<Vec<String>>>,
    /// This determines the maximum number of times `idleMessages` can be spoken during the call.  @default 3
    #[serde(rename = "idleMessageMaxSpokenCount", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub idle_message_max_spoken_count: Option<Option<f64>>,
    ...
    #[serde(rename = "idleTimeoutSeconds", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub idle_timeout_seconds: Option<Option<f64>>,
    ...
    #[serde(rename = "silenceTimeoutMessage", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub silence_timeout_message: Option<Option<String>>,
}
