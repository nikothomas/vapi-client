...
pub enum UpdateAssistantDtoServerMessagesItem {
...
impl std::fmt::Display for UpdateAssistantDtoServerMessagesItem {
...
impl Default for UpdateAssistantDtoServerMessagesItem {
    fn default() -> UpdateAssistantDtoServerMessagesItem {
