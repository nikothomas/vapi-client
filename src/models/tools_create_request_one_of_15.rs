...
pub struct ToolsCreateRequestOneOf15 {
    ...
    pub messages: Option<Option<Vec<models::CreateMcpToolDtoMessagesItem>>>,
...
impl ToolsCreateRequestOneOf15 {
    pub fn new(r#type: Type) -> ToolsCreateRequestOneOf15 {
