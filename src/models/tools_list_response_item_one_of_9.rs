...
pub struct ToolsListResponseItemOneOf9 {
    ...
    pub messages: Option<Option<Vec<models::TextEditorToolMessagesItem>>>,
...
impl ToolsListResponseItemOneOf9 {
    pub fn new(sub_type: SubType, id: String, org_id: String, created_at: String, updated_at: String, name: Name, r#type: Type) -> ToolsListResponseItemOneOf9 {
