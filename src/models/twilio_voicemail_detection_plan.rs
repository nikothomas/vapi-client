...
pub struct TwilioVoicemailDetectionPlan {
    ...
    #[serde(rename = "machineDetectionTimeout", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "machineDetectionSpeechThreshold", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "machineDetectionSpeechEndThreshold", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "machineDetectionSilenceTimeout", skip_serializing_if = "Option::is_none")]
