...
pub struct UpdateAssistantDtoCredentialsItemOneOf29 {
    /// AWS access key ID.
...
impl UpdateAssistantDtoCredentialsItemOneOf29 {
    pub fn new(aws_access_key_id: String, aws_secret_access_key: String, region: String, s3_bucket_name: String, s3_path_prefix: String, provider: Provider) -> UpdateAssistantDtoCredentialsItemOneOf29 {
