...
pub struct UpdateAssistantDtoModelOneOf11 {
    ...
    pub tools: Option<Option<Vec<models::PerplexityAiModelToolsItem>>>,
...
impl UpdateAssistantDtoModelOneOf11 {
    pub fn new(model: String, provider: Provider) -> UpdateAssistantDtoModelOneOf11 {
