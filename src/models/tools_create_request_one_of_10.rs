...
pub struct ToolsCreateRequestOneOf10 {
    ...
    pub messages: Option<Option<Vec<models::CreateQueryToolDtoMessagesItem>>>,
...
impl ToolsCreateRequestOneOf10 {
    pub fn new(r#type: Type) -> ToolsCreateRequestOneOf10 {
