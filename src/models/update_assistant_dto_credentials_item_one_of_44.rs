...
pub struct UpdateAssistantDtoCredentialsItemOneOf44 {
...
impl UpdateAssistantDtoCredentialsItemOneOf44 {
    pub fn new(authorization_id: String, provider: Provider) -> UpdateAssistantDtoCredentialsItemOneOf44 {
