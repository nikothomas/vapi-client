...
pub struct TestSuiteTestControllerCreateRequestOneOf1 {
...
impl TestSuiteTestControllerCreateRequestOneOf1 {
    pub fn new(scorers: Vec<models::TestSuiteTestScorerAi>, script: String, r#type: Type) -> TestSuiteTestControllerCreateRequestOneOf1 {
