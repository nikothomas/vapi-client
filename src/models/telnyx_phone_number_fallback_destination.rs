...
#[serde(untagged)]
pub enum TelnyxPhoneNumberFallbackDestination {
...
impl Default for TelnyxPhoneNumberFallbackDestination {
    fn default() -> Self {
