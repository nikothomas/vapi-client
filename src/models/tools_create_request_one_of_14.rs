...
pub struct ToolsCreateRequestOneOf14 {
    ...
    pub messages: Option<Option<Vec<models::CreateSlackSendMessageToolDtoMessagesItem>>>,
...
impl ToolsCreateRequestOneOf14 {
    pub fn new(r#type: Type) -> ToolsCreateRequestOneOf14 {
