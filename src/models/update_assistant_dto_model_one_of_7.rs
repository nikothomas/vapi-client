...
pub struct UpdateAssistantDtoModelOneOf7 {
    ...
    pub tools: Option<Option<Vec<models::GroqModelToolsItem>>>,
    ...
    #[serde(rename = "model")]
    pub model: models::GroqModelModel,
...
impl UpdateAssistantDtoModelOneOf7 {
    pub fn new(model: models::GroqModelModel, provider: Provider) -> UpdateAssistantDtoModelOneOf7 {
