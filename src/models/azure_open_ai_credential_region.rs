...
pub enum AzureOpenAiCredentialRegion {
...
impl std::fmt::Display for AzureOpenAiCredentialRegion {
...
impl Default for AzureOpenAiCredentialRegion {
    fn default() -> AzureOpenAiCredentialRegion {
        Self::Australia
    }
}
