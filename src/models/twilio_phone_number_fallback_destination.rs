...
#[serde(untagged)]
pub enum TwilioPhoneNumberFallbackDestination {
...
impl Default for TwilioPhoneNumberFallbackDestination {
    fn default() -> Self {
