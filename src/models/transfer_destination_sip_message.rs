...
#[serde(untagged)]
pub enum TransferDestinationSipMessage {
    String(String),
    CustomMessage(models::CustomMessage),
}

impl Default for TransferDestinationSipMessage {
    fn default() -> Self {
