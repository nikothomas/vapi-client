...
pub struct FallbackPlanVoicesItemOneOf5 {
...
impl FallbackPlanVoicesItemOneOf5 {
    pub fn new(voice_id: models::FallbackElevenLabsVoiceId, provider: Provider) -> FallbackPlanVoicesItemOneOf5 {
