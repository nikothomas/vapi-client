...
pub struct ToolsListResponseItemOneOf14 {
    ...
    pub messages: Option<Option<Vec<models::SlackSendMessageToolMessagesItem>>>,
...
impl ToolsListResponseItemOneOf14 {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String, r#type: Type) -> ToolsListResponseItemOneOf14 {
