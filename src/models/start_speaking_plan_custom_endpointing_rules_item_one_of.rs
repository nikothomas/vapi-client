...
pub struct StartSpeakingPlanCustomEndpointingRulesItemOneOf {
...
impl StartSpeakingPlanCustomEndpointingRulesItemOneOf {
    pub fn new(regex: String, timeout_seconds: f64, r#type: Type) -> StartSpeakingPlanCustomEndpointingRulesItemOneOf {
