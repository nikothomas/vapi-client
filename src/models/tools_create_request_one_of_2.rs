...
pub struct ToolsCreateRequestOneOf2 {
    ...
    pub messages: Option<Option<Vec<models::CreateFunctionToolDtoMessagesItem>>>,
...
impl ToolsCreateRequestOneOf2 {
    pub fn new(r#type: Type) -> ToolsCreateRequestOneOf2 {
