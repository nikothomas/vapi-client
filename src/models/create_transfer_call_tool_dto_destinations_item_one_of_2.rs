...
pub struct CreateTransferCallToolDtoDestinationsItemOneOf2 {
    #[serde(rename = "message", skip_serializing_if = "Option::is_none")]
    pub message: Option<models::TransferDestinationNumberMessage>,
    ...
    #[serde(rename = "callerId", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub caller_id: Option<Option<String>>,
...
impl CreateTransferCallToolDtoDestinationsItemOneOf2 {
    pub fn new(number: String, r#type: Type) -> CreateTransferCallToolDtoDestinationsItemOneOf2 {
