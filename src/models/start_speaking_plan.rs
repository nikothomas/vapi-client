...
pub struct StartSpeakingPlan {
    ...
    #[serde(rename = "smartEndpointingEnabled", skip_serializing_if = "Option::is_none")]
    pub smart_endpointing_enabled: Option<models::StartSpeakingPlanSmartEndpointingEnabled>,
    ...
    #[serde(rename = "customEndpointingRules", skip_serializing_if = "Option::is_none")]
