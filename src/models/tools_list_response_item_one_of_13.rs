...
pub struct ToolsListResponseItemOneOf13 {
    ...
    pub messages: Option<Option<Vec<models::GoogleCalendarCheckAvailabilityToolMessagesItem>>>,
...
impl ToolsListResponseItemOneOf13 {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String, r#type: Type) -> ToolsListResponseItemOneOf13 {
...
impl Default for Type {
    fn default() -> Type {
        Self::GooglePeriodCalendarPeriodAvailabilityPeriodCheck
    }
}
