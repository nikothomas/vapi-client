...
/// OpenAiVoiceId : This is the provider-specific ID that will be used. Please note that ash, ballad, coral, sage, and verse may only be used with realtime models.
...
impl std::fmt::Display for OpenAiVoiceId {
...
impl Default for OpenAiVoiceId {
    fn default() -> OpenAiVoiceId {
        Self::Alloy
    }
}
