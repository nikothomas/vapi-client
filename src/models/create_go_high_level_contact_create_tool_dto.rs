...
pub struct CreateGoHighLevelContactCreateToolDto {
...
impl CreateGoHighLevelContactCreateToolDto {
    pub fn new(r#type: TypeTrue) -> CreateGoHighLevelContactCreateToolDto {
