...
pub struct ToolsUpdateRequestOneOf5 {
    ...
    pub messages: Option<Option<Vec<models::UpdateTransferCallToolDtoMessagesItem>>>,
    ...
    pub destinations: Option<Option<Vec<models::UpdateTransferCallToolDtoDestinationsItem>>>,
...
impl ToolsUpdateRequestOneOf5 {
    pub fn new(r#type: Type) -> ToolsUpdateRequestOneOf5 {
