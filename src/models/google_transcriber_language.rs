...
/// GoogleTranscriberLanguage : This is the language that will be set for the transcription.
/// This is the language that will be set for the transcription.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum GoogleTranscriberLanguage {
...
impl std::fmt::Display for GoogleTranscriberLanguage {
...
impl Default for GoogleTranscriberLanguage {
    fn default() -> GoogleTranscriberLanguage {
        Self::Multilingual
    }
}
