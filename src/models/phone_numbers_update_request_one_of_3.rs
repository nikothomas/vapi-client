...
pub struct PhoneNumbersUpdateRequestOneOf3 {
    #[serde(rename = "fallbackDestination", skip_serializing_if = "Option::is_none")]
    pub fallback_destination: Option<models::UpdateVapiPhoneNumberDtoFallbackDestination>,
...
impl PhoneNumbersUpdateRequestOneOf3 {
    pub fn new(provider: Provider) -> PhoneNumbersUpdateRequestOneOf3 {
