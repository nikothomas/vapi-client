...
pub struct CreateGoogleCalendarCreateEventToolDto {
    ...
    pub messages: Option<Option<Vec<models::CreateGoogleCalendarCreateEventToolDtoMessagesItem>>>,
...
impl CreateGoogleCalendarCreateEventToolDto {
    pub fn new() -> CreateGoogleCalendarCreateEventToolDto {
