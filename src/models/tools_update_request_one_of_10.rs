...
pub struct ToolsUpdateRequestOneOf10 {
    ...
    pub messages: Option<Option<Vec<models::UpdateQueryToolDtoMessagesItem>>>,
...
impl ToolsUpdateRequestOneOf10 {
    pub fn new(r#type: Type) -> ToolsUpdateRequestOneOf10 {
