...
pub struct ClientMessageToolCallsToolWithToolCallListItemOneOf5 {
...
impl ClientMessageToolCallsToolWithToolCallListItemOneOf5 {
    pub fn new(sub_type: SubType, tool_call: models::ToolCall, name: Name, r#type: Type) -> ClientMessageToolCallsToolWithToolCallListItemOneOf5 {
