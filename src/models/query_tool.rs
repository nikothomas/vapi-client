...
pub struct QueryTool {
    ...
    #[serde(rename = "knowledgeBases", skip_serializing_if = "Option::is_none")]
    pub knowledge_bases: Option<Vec<models::KnowledgeBase>>,
...
impl QueryTool {
    pub fn new(r#type: TypeTrue, id: String, org_id: String, created_at: String, updated_at: String) -> QueryTool {
        QueryTool {
            messages: None,
            r#type,
