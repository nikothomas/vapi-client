...
pub struct FallbackPlanVoicesItemOneOf12 {
...
impl FallbackPlanVoicesItemOneOf12 {
    pub fn new(voice_id: models::FallbackTavusVoiceVoiceId, provider: Provider) -> FallbackPlanVoicesItemOneOf12 {
