...
pub struct ClientMessageTransferUpdate {
    ...
    pub destination: Option<Box<models::ClientMessageTransferUpdateDestination>>,
    ...
    pub to_assistant: Option<Box<models::CreateAssistantDto>>,
    ...
    pub from_assistant: Option<Box<models::CreateAssistantDto>>,
