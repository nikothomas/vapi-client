...
pub struct ToolsUpdateRequestOneOf {
    ...
    pub messages: Option<Option<Vec<models::UpdateDtmfToolDtoMessagesItem>>>,
...
impl ToolsUpdateRequestOneOf {
    pub fn new(r#type: Type) -> ToolsUpdateRequestOneOf {
