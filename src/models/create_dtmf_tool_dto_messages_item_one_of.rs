...
pub struct CreateDtmfToolDtoMessagesItemOneOf {
    ...
    #[serde(rename = "blocking", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub blocking: Option<Option<bool>>,
...
impl CreateDtmfToolDtoMessagesItemOneOf {
    pub fn new(r#type: Type) -> CreateDtmfToolDtoMessagesItemOneOf {
