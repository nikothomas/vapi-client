...
pub struct TestSuiteTestControllerUpdateRequestOneOf {
...
impl TestSuiteTestControllerUpdateRequestOneOf {
    pub fn new(r#type: Type) -> TestSuiteTestControllerUpdateRequestOneOf {
