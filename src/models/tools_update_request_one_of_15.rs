...
pub struct ToolsUpdateRequestOneOf15 {
    ...
    pub messages: Option<Option<Vec<models::UpdateMcpToolDtoMessagesItem>>>,
...
impl ToolsUpdateRequestOneOf15 {
    pub fn new(r#type: Type) -> ToolsUpdateRequestOneOf15 {
