...
pub enum FallbackDeepgramVoiceIdEnum {
...
impl std::fmt::Display for FallbackDeepgramVoiceIdEnum {
...
impl Default for FallbackDeepgramVoiceIdEnum {
    fn default() -> FallbackDeepgramVoiceIdEnum {
        Self::Asteria
    }
}
