...
pub struct CreateGoogleCalendarCheckAvailabilityToolDto {
...
impl CreateGoogleCalendarCheckAvailabilityToolDto {
    pub fn new() -> CreateGoogleCalendarCheckAvailabilityToolDto {
