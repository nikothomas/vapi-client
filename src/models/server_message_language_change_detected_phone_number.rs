...
/// ServerMessageLanguageChangeDetectedPhoneNumber : This is the phone number associated with the call.  This matches one of the following: - `call.phoneNumber`, - `call.phoneNumberId`.
...
#[serde(untagged)]
pub enum ServerMessageLanguageChangeDetectedPhoneNumber {
...
impl Default for ServerMessageLanguageChangeDetectedPhoneNumber {
    fn default() -> Self {
