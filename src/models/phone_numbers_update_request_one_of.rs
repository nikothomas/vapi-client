...
pub struct PhoneNumbersUpdateRequestOneOf {
    #[serde(rename = "fallbackDestination", skip_serializing_if = "Option::is_none")]
    pub fallback_destination: Option<models::UpdateByoPhoneNumberDtoFallbackDestination>,
...
impl PhoneNumbersUpdateRequestOneOf {
    pub fn new(provider: Provider) -> PhoneNumbersUpdateRequestOneOf {
