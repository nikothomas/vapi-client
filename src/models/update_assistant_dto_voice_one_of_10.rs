...
pub struct UpdateAssistantDtoVoiceOneOf10 {
...
impl UpdateAssistantDtoVoiceOneOf10 {
    pub fn new(voice_id: models::RimeAiVoiceId, provider: Provider) -> UpdateAssistantDtoVoiceOneOf10 {
