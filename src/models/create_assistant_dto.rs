...
pub struct CreateAssistantDto {
    ...
    pub first_message_mode: Option<models::CreateAssistantDtoFirstMessageMode>,
    ...
    pub client_messages: Option<Option<Vec<models::CreateAssistantDtoClientMessagesItem>>>,
    ...
    pub server_messages: Option<Option<Vec<models::CreateAssistantDtoServerMessagesItem>>>,
    ...
    pub credentials: Option<Option<Vec<models::CreateAssistantDtoCredentialsItem>>>,
