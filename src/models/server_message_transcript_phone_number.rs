...
/// ServerMessageTranscriptPhoneNumber : This is the phone number associated with the call.  This matches one of the following: - `call.phoneNumber`, - `call.phoneNumberId`.
...
#[serde(untagged)]
pub enum ServerMessageTranscriptPhoneNumber {
...
impl Default for ServerMessageTranscriptPhoneNumber {
    fn default() -> Self {
