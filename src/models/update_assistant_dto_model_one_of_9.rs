...
pub struct UpdateAssistantDtoModelOneOf9 {
    ...
    pub tools: Option<Option<Vec<models::OpenAiModelToolsItem>>>,
    ...
    #[serde(rename = "model")]
    pub model: models::OpenAiModelModel,
    ...
    #[serde(rename = "fallbackModels", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub fallback_models: Option<Option<Vec<models::OpenAiModelFallbackModelsItem>>>,
...
impl UpdateAssistantDtoModelOneOf9 {
    pub fn new(model: models::OpenAiModelModel, provider: Provider) -> UpdateAssistantDtoModelOneOf9 {
