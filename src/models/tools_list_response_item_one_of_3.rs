...
pub struct ToolsListResponseItemOneOf3 {
    ...
    pub messages: Option<Option<Vec<models::GhlToolMessagesItem>>>,
...
impl ToolsListResponseItemOneOf3 {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String, metadata: models::GhlToolMetadata, r#type: Type) -> ToolsListResponseItemOneOf3 {
