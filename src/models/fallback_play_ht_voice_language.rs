...
/// FallbackPlayHtVoiceLanguage : The language to use for the speech.
/// The language to use for the speech.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum FallbackPlayHtVoiceLanguage {
...
impl std::fmt::Display for FallbackPlayHtVoiceLanguage {
...
impl Default for FallbackPlayHtVoiceLanguage {
    fn default() -> FallbackPlayHtVoiceLanguage {
        Self::Afrikaans
    }
}
