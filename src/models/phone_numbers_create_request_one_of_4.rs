...
pub struct PhoneNumbersCreateRequestOneOf4 {
    #[serde(rename = "fallbackDestination", skip_serializing_if = "Option::is_none")]
    pub fallback_destination: Option<models::CreateTelnyxPhoneNumberDtoFallbackDestination>,
...
impl PhoneNumbersCreateRequestOneOf4 {
    pub fn new(number: String, credential_id: String, provider: Provider) -> PhoneNumbersCreateRequestOneOf4 {
