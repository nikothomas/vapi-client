...
#[serde(untagged)]
pub enum ImportVonagePhoneNumberDtoFallbackDestination {
...
impl Default for ImportVonagePhoneNumberDtoFallbackDestination {
    fn default() -> Self {
