...
pub struct GoHighLevelContactCreateToolWithToolCall {
...
impl GoHighLevelContactCreateToolWithToolCall {
    pub fn new(r#type: TypeTrue, tool_call: models::ToolCall) -> GoHighLevelContactCreateToolWithToolCall {
...
impl Default for TypeTrue {
    fn default() -> TypeTrue {
        Self::GohighlevelPeriodContactPeriodCreate
    }
}
