...
/// VapiVoiceVoiceId : The voices provided by Vapi
/// The voices provided by Vapi
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum VapiVoiceVoiceId {
    #[serde(rename = "Elliot")]
    Elliot,
    #[serde(rename = "Rohan")]
    Rohan,
...
impl std::fmt::Display for VapiVoiceVoiceId {
...
impl Default for VapiVoiceVoiceId {
    fn default() -> VapiVoiceVoiceId {
        Self::Elliot
    }
}
