...
pub enum UpdateAssistantDtoClientMessagesItem {
...
impl std::fmt::Display for UpdateAssistantDtoClientMessagesItem {
...
impl Default for UpdateAssistantDtoClientMessagesItem {
    fn default() -> UpdateAssistantDtoClientMessagesItem {
