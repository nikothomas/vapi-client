...
pub enum StartSpeakingPlanCustomEndpointingRulesInner {
    AssistantCustomEndpointingRule(Box<models::AssistantCustomEndpointingRule>),
    CustomerCustomEndpointingRule(Box<models::CustomerCustomEndpointingRule>),
    BothCustomEndpointingRule(Box<models::BothCustomEndpointingRule>),
}
