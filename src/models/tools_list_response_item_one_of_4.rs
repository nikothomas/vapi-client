...
pub struct ToolsListResponseItemOneOf4 {
    ...
    pub messages: Option<Option<Vec<models::MakeToolMessagesItem>>>,
...
impl ToolsListResponseItemOneOf4 {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String, metadata: models::MakeToolMetadata, r#type: Type) -> ToolsListResponseItemOneOf4 {
