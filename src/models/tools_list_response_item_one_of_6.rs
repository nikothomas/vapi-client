...
pub struct ToolsListResponseItemOneOf6 {
    ...
    pub messages: Option<Option<Vec<models::OutputToolMessagesItem>>>,
...
impl ToolsListResponseItemOneOf6 {
    pub fn new(id: String, org_id: String, created_at: String, updated_at: String, r#type: Type) -> ToolsListResponseItemOneOf6 {
