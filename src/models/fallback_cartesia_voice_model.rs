...
/// FallbackCartesiaVoiceModel : This is the model that will be used. This is optional and will default to the correct model for the voiceId.
...
pub enum FallbackCartesiaVoiceModel {
...
impl std::fmt::Display for FallbackCartesiaVoiceModel {
...
impl Default for FallbackCartesiaVoiceModel {
    fn default() -> FallbackCartesiaVoiceModel {
        Self::Sonic2
    }
}
