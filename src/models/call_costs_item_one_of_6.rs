...
pub struct CallCostsItemOneOf6 {
...
impl CallCostsItemOneOf6 {
    pub fn new(analysis_type: models::AnalysisCostAnalysisType, model: std::collections::HashMap<String, serde_json::Value>, prompt_tokens: f64, completion_tokens: f64, cost: f64, r#type: Type) -> CallCostsItemOneOf6 {
        CallCostsItemOneOf6 {
            analysis_type,
            model,
            prompt_tokens,
