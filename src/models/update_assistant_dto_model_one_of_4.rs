...
pub struct UpdateAssistantDtoModelOneOf4 {
    ...
    pub tools: Option<Option<Vec<models::DeepInfraModelToolsItem>>>,
...
impl UpdateAssistantDtoModelOneOf4 {
    pub fn new(model: String, provider: Provider) -> UpdateAssistantDtoModelOneOf4 {
