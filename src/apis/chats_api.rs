...
pub async fn chat_controller_create_chat(
    ...
    create_chat_dto: models::CreateChatDto,
) -> Result<models::ChatControllerCreateChat200Response, Error<ChatControllerCreateChatError>> {
...
pub async fn chat_controller_create_open_ai_chat(
    configuration: &configuration::Configuration,
    open_ai_responses_request: models::OpenAiResponsesRequest,
) -> Result<
    models::ChatControllerCreateOpenAiChat200Response,
    Error<ChatControllerCreateOpenAiChatError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ChatControllerCreateOpenAiChatError> =
...
pub async fn chat_controller_delete_chat(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::Chat, Error<ChatControllerDeleteChatError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn chat_controller_get_chat(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::Chat, Error<ChatControllerGetChatError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn chat_controller_list_chats(
    configuration: &configuration::Configuration,
...
) -> Result<models::ChatPaginatedResponse, Error<ChatControllerListChatsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
