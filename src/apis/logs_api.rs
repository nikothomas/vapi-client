...
/// struct for typed errors of method [`logs_logging_controller_logs_delete_query`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum LogsLoggingControllerLogsDeleteQueryError {
    UnknownValue(serde_json::Value),
}


pub async fn logs_get(configuration: &configuration::Configuration, r#type: Option<models::LogsGetRequestType>, webhook_type: Option<&str>, assistant_id: Option<&str>, phone_number_id: Option<&str>, customer_id: Option<&str>, squad_id: Option<&str>, call_id: Option<&str>, page: Option<f64>, sort_order: Option<models::LogsGetRequestSortOrder>, limit: Option<f64>, created_at_gt: Option<String>, created_at_lt: Option<String>, created_at_ge: Option<String>, created_at_le: Option<String>, updated_at_gt: Option<String>, updated_at_lt: Option<String>, updated_at_ge: Option<String>, updated_at_le: Option<String>) -> Result<models::LogsPaginatedResponse, Error<LogsGetError>> {
...
pub async fn logs_logging_controller_logs_delete_query(configuration: &configuration::Configuration, r#type: Option<models::LoggingControllerLogsDeleteQueryRequestType>, assistant_id: Option<&str>, phone_number_id: Option<&str>, customer_id: Option<&str>, squad_id: Option<&str>, call_id: Option<&str>) -> Result<(), Error<LogsLoggingControllerLogsDeleteQueryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_type = r#type;
    let p_assistant_id = assistant_id;
    let p_phone_number_id = phone_number_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<LogsLoggingControllerLogsDeleteQueryError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
