...
pub async fn test_suite_controller_find_all_paginated(
    configuration: &configuration::Configuration,
    page: Option<f64>,
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<TestSuiteControllerFindAllPaginatedError> =
...
pub async fn test_suite_controller_find_one(
    configuration: &configuration::Configuration,
    id: &str,
