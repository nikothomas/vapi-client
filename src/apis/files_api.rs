...
pub async fn file_controller_find_all(configuration: &configuration::Configuration, ) -> Result<Vec<models::File>, Error<FileControllerFindAllError>> {
...
pub async fn file_controller_find_one(configuration: &configuration::Configuration, id: &str) -> Result<models::File, Error<FileControllerFindOneError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn file_controller_remove(configuration: &configuration::Configuration, id: &str) -> Result<models::File, Error<FileControllerRemoveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn file_controller_update(configuration: &configuration::Configuration, id: &str, update_file_dto: models::UpdateFileDto) -> Result<models::File, Error<FileControllerUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
