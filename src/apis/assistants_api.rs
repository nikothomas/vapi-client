...
/// struct for typed errors of method [`assistants_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AssistantsCreateError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`assistants_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AssistantsDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`assistants_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AssistantsGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`assistants_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AssistantsListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`assistants_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AssistantsUpdateError {
    UnknownValue(serde_json::Value),
}


pub async fn assistants_create(configuration: &configuration::Configuration, create_assistant_dto: models::CreateAssistantDto) -> Result<models::Assistant, Error<AssistantsCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AssistantsCreateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn assistants_delete(configuration: &configuration::Configuration, id: &str) -> Result<models::Assistant, Error<AssistantsDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AssistantsDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn assistants_get(configuration: &configuration::Configuration, id: &str) -> Result<models::Assistant, Error<AssistantsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AssistantsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn assistants_list(configuration: &configuration::Configuration, limit: Option<f64>, created_at_gt: Option<String>, created_at_lt: Option<String>, created_at_ge: Option<String>, created_at_le: Option<String>, updated_at_gt: Option<String>, updated_at_lt: Option<String>, updated_at_ge: Option<String>, updated_at_le: Option<String>) -> Result<Vec<models::Assistant>, Error<AssistantsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_limit = limit;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AssistantsListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn assistants_update(configuration: &configuration::Configuration, id: &str, assistants_update_request: models::AssistantsUpdateRequest) -> Result<models::Assistant, Error<AssistantsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_assistants_update_request = assistants_update_request;
    ...
    req_builder = req_builder.json(&p_assistants_update_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AssistantsUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
