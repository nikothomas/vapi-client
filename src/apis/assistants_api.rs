...
pub async fn assistant_controller_create(
...
pub async fn assistant_controller_find_all(
    configuration: &configuration::Configuration,
    limit: Option<f64>,
...
pub async fn assistant_controller_find_one(
    configuration: &configuration::Configuration,
    id: &str,
...
pub async fn assistant_controller_remove(
    configuration: &configuration::Configuration,
    id: &str,
...
pub async fn assistant_controller_update(
    configuration: &configuration::Configuration,
    id: &str,
