...
pub async fn test_suite_run_controller_create(configuration: &configuration::Configuration, test_suite_id: &str, create_test_suite_run_dto: models::CreateTestSuiteRunDto) -> Result<models::TestSuiteRun, Error<TestSuiteRunControllerCreateError>> {
...
pub async fn test_suite_run_controller_find_all_paginated(configuration: &configuration::Configuration, test_suite_id: &str, page: Option<f64>, sort_order: Option<&str>, limit: Option<f64>, created_at_gt: Option<String>, created_at_lt: Option<String>, created_at_ge: Option<String>, created_at_le: Option<String>, updated_at_gt: Option<String>, updated_at_lt: Option<String>, updated_at_ge: Option<String>, updated_at_le: Option<String>) -> Result<models::TestSuiteRunsPaginatedResponse, Error<TestSuiteRunControllerFindAllPaginatedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_test_suite_id = test_suite_id;
    let p_page = page;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<TestSuiteRunControllerFindAllPaginatedError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn test_suite_run_controller_find_one(configuration: &configuration::Configuration, test_suite_id: &str, id: &str) -> Result<models::TestSuiteRun, Error<TestSuiteRunControllerFindOneError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_test_suite_id = test_suite_id;
    let p_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<TestSuiteRunControllerFindOneError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn test_suite_run_controller_remove(configuration: &configuration::Configuration, test_suite_id: &str, id: &str) -> Result<models::TestSuiteRun, Error<TestSuiteRunControllerRemoveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_test_suite_id = test_suite_id;
    let p_id = id;
...
pub async fn test_suite_run_controller_update(configuration: &configuration::Configuration, test_suite_id: &str, id: &str, update_test_suite_run_dto: models::UpdateTestSuiteRunDto) -> Result<models::TestSuiteRun, Error<TestSuiteRunControllerUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_test_suite_id = test_suite_id;
    let p_id = id;
