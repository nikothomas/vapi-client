...
pub async fn knowledge_base_controller_create(
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<KnowledgeBaseControllerCreateError> =
...
pub async fn knowledge_base_controller_find_all(
    configuration: &configuration::Configuration,
    limit: Option<f64>,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<KnowledgeBaseControllerFindAllError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn knowledge_base_controller_find_one(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<
    models::KnowledgeBaseControllerFindAll200ResponseInner,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<KnowledgeBaseControllerFindOneError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<KnowledgeBaseControllerRemoveError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<KnowledgeBaseControllerUpdateError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
