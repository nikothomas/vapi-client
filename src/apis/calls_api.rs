...
pub async fn call_controller_create(
    configuration: &configuration::Configuration,
    create_call_dto: models::CreateCallDto,
) -> Result<models::CallControllerCreate201Response, Error<CallControllerCreateError>> {
...
pub async fn call_controller_delete_call_data(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::Call, Error<CallControllerDeleteCallDataError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn call_controller_find_all(
    configuration: &configuration::Configuration,
    id: Option<&str>,
...
) -> Result<Vec<models::Call>, Error<CallControllerFindAllError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn call_controller_find_one(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::Call, Error<CallControllerFindOneError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn call_controller_update(
    configuration: &configuration::Configuration,
    id: &str,
    update_call_dto: models::UpdateCallDto,
) -> Result<models::Call, Error<CallControllerUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
