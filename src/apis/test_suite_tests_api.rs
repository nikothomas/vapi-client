...
pub async fn test_suite_test_controller_create(
    ...
    models::TestSuiteTestControllerCreate201Response,
    Error<TestSuiteTestControllerCreateError>,
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<TestSuiteTestControllerCreateError> =
...
pub async fn test_suite_test_controller_find_all_paginated(
    configuration: &configuration::Configuration,
    test_suite_id: &str,
    page: Option<f64>,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<TestSuiteTestControllerFindAllPaginatedError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn test_suite_test_controller_find_one(
    configuration: &configuration::Configuration,
    test_suite_id: &str,
    id: &str,
) -> Result<
    models::TestSuiteTestControllerCreate201Response,
    Error<TestSuiteTestControllerFindOneError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_test_suite_id = test_suite_id;
    let p_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<TestSuiteTestControllerFindOneError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<TestSuiteTestControllerRemoveError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn test_suite_test_controller_update(
    ...
    models::TestSuiteTestControllerCreate201Response,
    Error<TestSuiteTestControllerUpdateError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_test_suite_id = test_suite_id;
    let p_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<TestSuiteTestControllerUpdateError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
